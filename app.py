...
st.markdown(
    ...
    3. Enter quantities in Column D.<br>
    4. Select the purchase unit in Column E.<br>
    5. Modify Category in Column C if required.<br>
...
if st.session_state.requirement is not None:
    ...
    st.caption(
        ...
        "Quantity and Purchase Unit can be entered for each item."
    )
    ...
    st.session_state.requirement = edited_df
